        ...
        <div className="blogs">
          <div className="blog blog1">
            ...
            <div className="blog-content">
              <span className="blog-badge" style={{ color: "violet" }}>
                RESOURCES
              </span>
          ...
          <div className="blog blog2">
            ...
            />
            <div className="blog-content">
              <span className="blog-badge" style={{ color: "skyblue" }}>
                LIFESTYLE
              </span>
              <h2>Refreshing Designs</h2>
              <p style={{ fontSize: "small" }}>
          ...
          <div className="blog blog3">
            ...
            />
            <div className="blog-content">
              <span className="blog-badge" style={{ color: "yellow" }}>
                ENTERTAINMENT
              </span>
  ...
  return (
    <div className="blog-card">
      ...
      <div className="blog-content-card">
        ...
        <h5 style={{fontSize:"1.6rem",letterSpacing:"2px",fontWeight:"bold"}}>Refreshing Designs</h5>
        <p style={{ fontSize: "0.8rem" ,letterSpacing:"2px",fontWeight:"300"}}>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum
